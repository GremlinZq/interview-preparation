const DeclarationsVisual = (() => {
  const diagramSelector = "[data-variable-diagram]";
  ...
  function setupDeclarationsVisual(
  ...
  return { setupDeclarationsVisual };
})();

if (typeof window !== "undefined") {
  window.DeclarationsVisual = DeclarationsVisual;
}

if (typeof document !== "undefined") {
  const autoInitialize = () => {
    DeclarationsVisual.setupDeclarationsVisual(document);
  };
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = DeclarationsVisual;
}
